...
const Header = () => {
    ...
    return (<div className="bg-white flex items-center p-2 shadow-md top-0 sticky z-50 h-16">
        {/* Left */}
        ...
        <div className="flex items-center space-x-2 px-2 ml-2 rounded-full bg-gray-100 text-gray-500">
            ...
            <input className="hidden lg:inline-flex bg-transparent focus:outline-none" type="text"
        ...
        <div className="flex items-center justify-end min-w-fit space-x-2">
            ...
            <CgMenuGridO size={20}
                         className="hidden lg:inline-flex h-10 w-10 bg-gray-200 text-gray-600 rounded-full px-2 cursor-pointer hover:bg-gray-300"/>
